              ...
              <div className="space-y-4 text-gray-300">
                <div>
                  ...
                  <li className="ml-4">
                    <p className="px-2">
                      {" "}
                      Developed an E-Commerce Website (PHP, MySQL): Implemented
                      product listing, shopping cart, and checkout system.
                    </p>
                  </li>
                  <br />
                  <li className="ml-4">
                    <p className="px-2">
                      {" "}
                      Developed a restaurant Management System (HTML, CSS,
                      JavaScript, PHP, MySQL): Designed ordering and billing
                      features for a mini-restaurant.
                    </p>
                  </li>
                </div>
                <div>
                  ...
                  <li className="ml-4">
                    <p className="px-2">
                      {" "}
                      Developed a News Website (React.js): Created a responsive
                      news website with real-time updates and API integration.
                    </p>
                  </li>
                  <br />
                  ...
                  <li className="ml-4">
                    <p className="px-2">
                      {" "}
                      Developed a Calculator App (React.js): Built a simple
                      calculator app with a user-friendly interface and
                  ...
                  <li className="ml-4">
                    <p className="px-2">
                      {" "}
                      Developed a Personal Portfolio Website (React.js):
                  ...
                  <li className="ml-4">
                    <p className="px-2">
                      {" "}
                      Developed a E-commerce Website (React.js): Created a fully
                      functional e-commerce website with product listings,
